...
var table_skill = {
  ...
  //  槍防
  //--------------------------------
  "槍隊堅守":   { t:"none", k:"槍", per:20, def:10 },
  "槍隊堅陣":   { t:"none", k:"槍", per:30, def:12 },
  "槍隊備え":   { t:"none", k:"槍", per:10, def:15 },
  "槍隊守備":   { t:"cost", k:"槍", per:16, def_r:5 },
  "槍隊布陣":   { t:"none", k:"槍", per:15, def:20 },
  "豪放磊落":   { t:"none", k:"槍", per:40, def:20 },
  "槍隊円陣":   { t:"none", k:"槍", per:40, def:20 },
  "火牛の計":   { t:"none", k:"槍", per:37, def:23 },
  "忠節の槍":   { t:"none", k:"槍", per:12, def:26 },
  "槍隊守護":   { t:"cost", k:"槍", per:25, def_r:6.5 },
  "槍陣の極み": { t:"none", k:"槍", per:30, def:30 },
  "甲駿の誓い": { t:"none", k:"槍", per:40, def:35 },
//  "槍隊堅陣":   { t:"none", k:"槍", per:30, def:12 },
  ...
  //  弓防
  //--------------------------------
  "弓隊堅守":   { t:"none", k:"弓", per:20, def:10 },
  "弓隊堅陣":   { t:"none", k:"弓", per:30, def:12 },
  "弓隊備え":   { t:"none", k:"弓", per:10, def:15 },
  "弓隊守備":   { t:"cost", k:"弓", per:16, def_r:5 },
  "弓隊布陣":   { t:"none", k:"弓", per:15, def:20 },
  "忍耐の遠矢": { t:"none", k:"弓", per:20, def:33 },
  "弓隊円陣":   { t:"none", k:"弓", per:40, def:20 },
  "弓隊守護":   { t:"cost", k:"弓", per:25, def_r:6.5 },
  "弓陣の極み": { t:"none", k:"弓", per:30, def:30 },
  "三矢の礎":   { t:"none", k:"弓", per:40, def:35 },
  ...
  //  馬防
  //--------------------------------
  "騎馬隊堅守":   { t:"none", k:"馬", per:20, def:10 },
  "騎馬隊堅陣":   { t:"none", k:"馬", per:30, def:12 },
  "騎馬隊備え":   { t:"none", k:"馬", per:10, def:15 },
  "騎馬隊守備":   { t:"cost", k:"馬", per:16, def_r:5 },
  "騎馬隊布陣":   { t:"none", k:"馬", per:15, def:20 },
  "騎馬隊円陣":   { t:"none", k:"馬", per:40, def:20 },
  "騎馬隊守護":   { t:"cost", k:"馬", per:25, def_r:6.5 },
  "馬陣の極み":   { t:"none", k:"馬", per:30, def:30 },
  "貴婦人の返礼": { t:"none", k:"馬", per:17, def:54 },
  ...
  //  砲防
  //--------------------------------
  "鉄砲隊堅陣":   { t:"none", k:"砲", per:30, def:12 },
  "鉄砲隊備え":   { t:"none", k:"砲", per:10, def:15 },
  "鉄砲隊布陣":   { t:"none", k:"砲", per:15, def:20 },
  "鉄砲隊円陣":   { t:"none", k:"砲", per:40, def:20 },
  "鳥瞰銃座陣":   { t:"none", k:"砲", per:35, def:25 },
  "鉄砲隊守護":   { t:"cost", k:"砲", per:25, def_r:6.5 },
  "黒骨扇月丸":   { t:"none", k:"砲", per:20, def:30 },
  "智の八犬士":   { t:"none", k:"砲", per:25, def:30 },
  "砲陣の極み":   { t:"none", k:"砲", per:30, def:30 },
  "愛山護法":     { t:"none", k:"砲", per:60, def:30 },
  "根来闇鉄砲":   { t:"none", k:"砲", per:33, def:33 },
  "釣り野伏 真":  { t:"none", k:"砲", per:35, def:35 },
  "轟閻 霹靂火":  { t:"none", k:"砲", per:40, def:36 },
  ...
  //  器防
  //--------------------------------
  "兵器布陣":   { t:"none", k:"器", per:15, def:20 },
  "龍哭の酒":   { t:"none", k:"器", per:25, def:30 },
  ...
  //  槍弓防
  //--------------------------------
  "鐘切り":     { t:"none", k:"槍弓", per:20, def:20 },
  "鉄甲陣":     { t:"none", k:"槍弓", per:30, def:20 },
  "浅草浪人隊": { t:"none", k:"槍弓", per:20, def:25 },
  "血路の殿":   { t:"none", k:"槍弓", per:60, def:25 },
  "七槍の極":   { t:"none", k:"槍弓", per:30, def:30 },
  "賢女烈婦":   { t:"none", k:"槍弓", per:30, def:33 },
//  "援槍励檄":   { t:"none", k:"槍弓", per:30, def:35 },
  "円陣 楔":    { t:"none", k:"槍弓", per:30, def:36 },
  "元の木阿弥": { t:"none", k:"槍弓", per:20, def:39 },
  "死兵六道契": { t:"none", k:"槍弓", per:25, def:39 },
  "上州の黄斑": { t:"none", k:"槍弓", per:25, def:40 },
  "房州の意地": { t:"none", k:"槍弓", per:20, def:50 },
  ...
  //  槍馬防
  //--------------------------------
//  "老練ノ伏兵":   { t:"none", k:"槍馬", per:24, def:26 },
  "千樹挟撃陣":   { t:"none", k:"槍馬", per:35, def:28 },
  "七槍の匠":     { t:"none", k:"槍馬", per:30, def:30 },
  "甲州法度":     { t:"none", k:"槍馬", per:30, def:32 },
  "蛍火":         { t:"none", k:"槍馬", per:30, def:37 },
  "戦姫 瑞玉":    { t:"none", k:"槍馬", per:30, def:39 },
  "楔外交":       { t:"cost", k:"槍馬", per:33, def_r:12 },
  "慟哭の義将":   { t:"none", k:"槍馬", per:34, def:34 },
  "信濃の獅子":   { t:"none", k:"槍馬", per:20, def:50 },
//  "天つ凪ノ方喰": { t:"none", k:"槍馬", per:24, def:65 },
  ...
  //  槍砲防
  //--------------------------------
  "船穿応射":   { t:"none", k:"槍砲", per:20, def:10 },
  "清鏡宗心":   { t:"none", k:"槍砲", per:20, def:20 },
  "槍砲方陣":   { t:"none", k:"槍砲", per:40, def:20 },
  "三つ鱗巴陣": { t:"none", k:"槍砲", per:35, def:25 },
  "月読の偃武": { t:"none", k:"槍砲", per:55, def:26 },
  "鬼笛乃可勢": { t:"none", k:"槍砲", per:20, def:30 },
  "七槍の義":   { t:"none", k:"槍砲", per:30, def:30 },
  "忠魂座禅陣": { t:"none", k:"槍砲", per:35, def:30 },
  "日輪の礎":   { t:"none", k:"槍砲", per:20, def:35 },
  "独眼竜轟雷": { t:"none", k:"槍砲", per:35, def:40 },
  "不屈の再興": { t:"none", k:"槍砲", per:15, def:44 },
  "大金星":     { t:"none", k:"槍砲", per:1, def:60 },
//  "戦陣巴龍":   { t:"rank", k:"槍砲", per:35, def:28 },
  ...
  //  弓器攻
  //--------------------------------
  "火竜の術": { t:"none", k:"弓器", per:20, atk:15, des:15 },
  "夢想宴舞": { t:"none", k:"弓器", per:20, atk:15, des:15 },
  "謀神":     { t:"none", k:"弓器", per:50, atk:20, dse:30 },
  /*
  ...
  */
  ...
  //  馬砲攻
  //--------------------------------
  "馬上砲術":    { t:"none", k:"馬砲", per:60, atk:15 },
  "馬砲連撃":    { t:"none", k:"馬砲", per:30, atk:20 },
  "三鱗竜騎兵":  { t:"none", k:"馬砲", per:30, atk:20 },
  "虎砲英主":    { t:"none", k:"馬砲", per:30, atk:20 },
  "洗礼の旗印":  { t:"none", k:"馬砲", per:35, atk:25 },
  "玄狐跳澗":    { t:"none", k:"馬砲", per:30, atk:30 },
  "焔 六冥銭":   { t:"none", k:"馬砲", per:30, atk:30 },
  "旋風轟撃":    { t:"none", k:"馬砲", per:35, atk:30 },
  "猿夜叉":      { t:"none", k:"馬砲", per:35, atk:30, des:10 },
  "冥戦焔騎":    { t:"night_eff", k:"馬砲", per_b:12, per_r:3, atk_b:39 },
  "成香 雀刺":   { t:"none", k:"馬砲", per:10, atk:40 },
  "武神 火車懸": { t:"none", k:"馬砲", per:17, atk:38 },
  "天戒 五芒星": { t:"none", k:"馬砲", per:35, atk:40 },
  ...
  //  槍弓馬攻
  //--------------------------------
  "傾奇戦国一":  { t:"none", k:"槍弓馬", per:30, atk:20 },
  "攻め弾正":    { t:"none", k:"槍弓馬", per:35, atk:20, des:15 },
  "礼の八犬士":  { t:"none", k:"槍弓馬", per:40, atk:20 },
  "甲虎襲踏":    { t:"none", k:"槍弓馬", per:30, atk:25 },
  "戦華白虎":    { t:"none", k:"槍弓馬", per:30, atk:25 },
  "紅蓮赤備":    { t:"none", k:"槍弓馬", per:30, atk:25 },
  "車懸り 白狐": { t:"none", k:"槍弓馬", per:20, atk:30 },
  "手負い獅子":  { t:"none", k:"槍弓馬", per:20, atk:30, des:10 },
  "五山無双":    { t:"none", k:"槍弓馬", per:20, atk:30, des:10 },
  "越龍滅閃":    { t:"none", k:"槍弓馬", per:25, atk:30 },
  "滅覇渾身":    { t:"none", k:"槍弓馬", per:30, atk:30, des:5 },
  "風林火山 戦": { t:"none", k:"槍弓馬", per:35, atk:30 },
  "神将":        { t:"none", k:"槍弓馬", per:35, atk:30 },
  "忠勇義烈":    { t:"none", k:"槍弓馬", per:40, atk:30, des:20 },
  "風林火山":    { t:"none", k:"槍弓馬", per:45, atk:30, des:15 },
  "無双獅子":    { t:"none", k:"槍弓馬", per:45, atk:30, des:35 },
  "地黄八幡 真": { t:"none", k:"槍弓馬", per:30, atk:32 },
  "龍祖昇躍":    { t:"none", k:"槍弓馬", per:30, atk:35},
  "赤鬼刺":      { t:"cost", k:"槍弓馬", per:15, atk_r:12 },
  "飛将 蜻蛉切": { t:"cost", k:"槍弓馬", per:25, atk_r:12 },
  "無双蜻蛉切":  { t:"cost", k:"槍弓馬", per:40, atk_r:13 },
  "修羅の援兵":  { t:"goryu_eff", k:"槍弓馬", per_b:25, atk_b:25, atk_r:2 },
  "三山統一":    { t:"none", k:"槍弓馬", per:16, atk:52 },
  "雷斬仁将":    { t:"mamushi", k:"槍弓馬", per_r:3, atk:52 },
  /*
  {"刀八毘沙門天", "1部隊", "槍弓馬", 20, 65, 0, 0, 0, "合流攻撃時は必ずスキル発動"},
  {"刀八毘沙門天", "合流", "槍弓馬", 100, 65, 0, 0, 0, "合流攻撃時は必ずスキル発動"},
  */
  "天征相克":    { t:"none", k:"槍弓馬", per:50, atk:70 },
  ...
  //  槍馬砲攻
  //--------------------------------
  "綾羅錦繍":    { t:"none", k:"槍馬砲", per:30, atk:17 },
  "風流雷火":    { t:"none", k:"槍馬砲", per:35, atk:20 },
  "風流嵐舞":    { t:"none", k:"槍馬砲", per:25, atk:25 },
  "竜眼月影":    { t:"none", k:"槍馬砲", per:25, atk:25, des:10 },
  "七槍の勇":    { t:"none", k:"槍馬砲", per:30, atk:25 },
  "貴煌豊国":    { t:"none", k:"槍馬砲", per:30, atk:25 },
  "剛勇無双":    { t:"none", k:"槍馬砲", per:30, atk:25 },
  "九曜激昂":    { t:"none", k:"槍馬砲", per:25, atk:27 },
  "覇道 不如帰": { t:"none", k:"槍馬砲", per:30, atk:30, des:30 },
  "声遣縦横":    { t:"none", k:"槍馬砲", per:24, atk:38 },
  "鬼五郎左":    { t:"none", k:"槍馬砲", per:26, atk:38 },
  "黒鬼刺":      { t:"cost", k:"槍馬砲", per:15, atk_r:10 },
  /*
